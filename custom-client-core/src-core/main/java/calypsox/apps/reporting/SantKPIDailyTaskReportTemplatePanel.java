...
public class SantKPIDailyTaskReportTemplatePanel extends SantGenericReportTemplatePanel {

	private static final long serialVersionUID = 3243801329380021986L;

	private SantChooseButtonPanel kpiAgrStatusPanel;
	...
	protected void buildControlsPanel() {
		...
		this.kpiAgrStatusPanel = new SantChooseButtonPanel("Agr Status", "CollateralStatus");
	...
	protected Border getMasterPanelBorder() {
		final TitledBorder titledBorder = BorderFactory.createTitledBorder("KPI Daily Task");
	...
	protected JPanel getColumn2Panel() {
		...
		column2Panel.add(this.kpiAgrStatusPanel);
	...
	public ReportTemplate getTemplate() {
		...
		this.reportTemplate.put(SantGenericTradeReportTemplate.AGREEMENT_STATUS, this.kpiAgrStatusPanel.getValue());
	...
	public void setTemplate(final ReportTemplate template) {
		...
		this.kpiAgrStatusPanel.setValue(template, SantGenericTradeReportTemplate.AGREEMENT_STATUS);
	}
}
