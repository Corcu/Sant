...
public class SantExceptions {
    ...
    private List<SantException> exceptions = new ArrayList<SantException>();
     ...
     *            the exception type
     * @param eventClass
     *            event class of the exception type
     * @param source
     *            the source
     * @param comment
     *            the comment
     ...
     *            the ds
     * @param evId
     *            an event id (long) that generated the TaskArray (may be 0)
     * @param engineName
     *            an engine name (String) that generated the TaskArray (may be
