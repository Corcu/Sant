 ...
 */
public class PerformanceSwapTradeMICReportTemplate extends TradeReportTemplate {

    //    private static final String TF_NAME = "PerformanceSwapMIC";
    private static final long serialVersionUID = -1655127533046540816L;

    public PerformanceSwapTradeMICReportTemplate() {
        super();
    }
