...
public class ExpTLM_InfRatesReportStyle extends QuoteReportStyle {
	...
	public Object getColumnValue(ReportRow row, String columnName,  @SuppressWarnings("rawtypes") Vector errors)
		...
		ExpTLM_InfRatesItem item = (ExpTLM_InfRatesItem) row.getProperty(ExpTLM_InfRatesItem.EXPTLM_INFRATES_ITEM);
