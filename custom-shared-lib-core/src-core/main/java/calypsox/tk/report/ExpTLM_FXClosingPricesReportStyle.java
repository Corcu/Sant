...
public class ExpTLM_FXClosingPricesReportStyle extends QuoteReportStyle {
	...
	public Object getColumnValue(ReportRow row, String columnName,  @SuppressWarnings("rawtypes") Vector errors)
		...
		ExpTLM_FXClosingPricesItem item = (ExpTLM_FXClosingPricesItem) row.getProperty(ExpTLM_FXClosingPricesItem.EXPTLM_FXCLOSINGPRICES_ITEM);
