 ...
 */
public class ExpTLM_InfRatesLogic {
	...
	public ExpTLM_InfRatesLogic() {
	}

	@SuppressWarnings("unused")
	private ExpTLM_InfRatesItem getExpTLM_InfRatesItem(final Vector<String> errors) {
		return null;
	}
	 ...
	 */
	public static Vector<ExpTLM_InfRatesItem> getReportRows(final QuoteValue qv, final String date, final String feed,
			final HashMap<String, String> feedMap, final DSConnection dsConn, final Vector<String> errorMsgs) {

		final Vector<ExpTLM_InfRatesItem> reportRows = new Vector<ExpTLM_InfRatesItem>();
		final ExpTLM_InfRatesLogic verifiedRow = new ExpTLM_InfRatesLogic();
		ExpTLM_InfRatesItem rowCreated = null;
		fecha = date;
		feed_name = feed;
	 ...
	 */
	private ExpTLM_InfRatesItem getExpTLM_InfRatesItem(final QuoteValue qv, final HashMap<String, String> feedMap,
			final DSConnection dsConn, final Vector<String> errors) {

		String indexKey;
		final ExpTLM_InfRatesItem expTLM_InfRatesItem = new ExpTLM_InfRatesItem();
