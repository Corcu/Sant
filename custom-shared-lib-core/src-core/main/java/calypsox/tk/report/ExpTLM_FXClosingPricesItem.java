 ...
 */
public class ExpTLM_FXClosingPricesItem {
	
	/**
     * Identify the object FXClosingPricesItem.
     */
	public static final String EXPTLM_FXCLOSINGPRICES_ITEM = "ExpTLM_FXClosingPricesItem";
	...
	public ExpTLM_FXClosingPricesItem(){}
