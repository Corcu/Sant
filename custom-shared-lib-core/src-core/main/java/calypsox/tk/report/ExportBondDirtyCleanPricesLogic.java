 ...
 */
public class ExportBondDirtyCleanPricesLogic {
    ...
    public ExportBondDirtyCleanPricesLogic() {
        //EMPTY
    }

    @SuppressWarnings("unused")
    private ExpTLM_BondPricesItem getExpTLM_BondPricesItem(final Vector<String> errors) {
        return null;
    }
     ...
     */
    public String getDirtyPrice(final QuoteValue qv) {
     ...
     */
    public static Vector<ExportBondDirtyCleanPricesItem> getReportRows(final QuoteValue qv, final String date,
                                                                       final String feed, String price_type, final DSConnection dsConn, final Vector<String> errorMsgs) {

        final Vector<ExportBondDirtyCleanPricesItem> reportRows = new Vector<ExportBondDirtyCleanPricesItem>();
        final ExportBondDirtyCleanPricesLogic verifiedRow = new ExportBondDirtyCleanPricesLogic();
        ExportBondDirtyCleanPricesItem rowCreated = null;
        fecha = date;
        feed_name = feed;
     ...
     */
    private ExportBondDirtyCleanPricesItem getExpTLM_BondPricesItem(final QuoteValue qv, final DSConnection dsConn,
                                                                    final Vector<String> errors) {

        final ExportBondDirtyCleanPricesItem bondDirtyCleanPrices = new ExportBondDirtyCleanPricesItem();
        ...
        if (qv != null) {
            ...
            bondDirtyCleanPrices.setFecha(getFecha());
            bondDirtyCleanPrices.setFeed(getFeed());
            bondDirtyCleanPrices.setLado(getLado());
            bondDirtyCleanPrices.setIsin(isin);
            bondDirtyCleanPrices.setDirty_price(getDirtyPrice(qv));
            bondDirtyCleanPrices.setIndicador(getIndicador());

            return bondDirtyCleanPrices;
