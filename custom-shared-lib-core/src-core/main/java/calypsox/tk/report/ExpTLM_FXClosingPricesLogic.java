 ...
 */
public class ExpTLM_FXClosingPricesLogic {
	...
	public ExpTLM_FXClosingPricesLogic() {
	}

	@SuppressWarnings("unused")
	private ExpTLM_FXClosingPricesItem getExpTLM_FXClosingPricesItem(Vector<String> errors) {
		return null;
	}
	 ...
	 */
	public static Vector<ExpTLM_FXClosingPricesItem> getReportRows(QuoteValue qv, String date, String feed,
			DSConnection dsConn, Vector<String> errorMsgs) {

		Vector<ExpTLM_FXClosingPricesItem> reportRows = new Vector<ExpTLM_FXClosingPricesItem>();
		ExpTLM_FXClosingPricesLogic verifiedRow = new ExpTLM_FXClosingPricesLogic();
		ExpTLM_FXClosingPricesItem rowCreated = null;
		fecha = date;
		feed_name = feed;
	 ...
	 */
	private ExpTLM_FXClosingPricesItem getExpTLM_FXClosingPricesItem(QuoteValue qv, DSConnection dsConn,
			Vector<String> errors) {

		ExpTLM_FXClosingPricesItem expTLM_FXClosingPricesItem = new ExpTLM_FXClosingPricesItem();
