...
public class QuotesListsRequests {

    @XmlElement(required = true)
    protected List<QuotesListRequest> quotesList;
     ...
     * {@link QuotesListRequest }
     * 
     * 
     */
    public List<QuotesListRequest> getQuotesList() {
        if (quotesList == null) {
            quotesList = new ArrayList<QuotesListRequest>();
        }
