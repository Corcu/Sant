...
import com.calypso.jaxb.xml.Quote;
...
public class ObjectFactory {
	 ...
	 * 
	 */
	public QuotesListsResponses createQuotesLists() {
		return new QuotesListsResponses();
	}
	 ...
	 * 
	 */
	public QuotesListResponse createQuotesList() {
		return new QuotesListResponse();
	}
