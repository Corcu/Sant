 ...
 *
 */
public class SantanderSLBKondorPlusIEAdapter extends
		SantanderKondorPlusIEAdapter {

	public SantanderSLBKondorPlusIEAdapter(IEAdapterMode mode) {
		super(mode);
	}
	...
	public void setIEAdapterConfig(final IEAdapterConfig config) {
		...
		try {
			if (isSender()) {
				this.outputAdapter = new SLBKondorPlusJMSQueueIEAdapter(JMSTopicIEAdapter.SENDER);
