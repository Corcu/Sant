...
public class DefaultAttachPortfolioMessageRule implements WfMessageRule {
	...
	public String getDescription() {
		return "This rule will set the information to attach the portfolio to true while sending notifications";
	}
	...
	public boolean update(TaskWorkflowConfig wc, BOMessage message,
		...
		message.setAttribute(MarginCallConstants.MESSAGE_ATTR_ATTACH_PORTFOLIO, "true");
		return true;
	}
