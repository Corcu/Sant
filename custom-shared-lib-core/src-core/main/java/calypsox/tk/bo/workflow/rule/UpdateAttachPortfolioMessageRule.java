...
public class UpdateAttachPortfolioMessageRule implements WfMessageRule {
	...
	public String getDescription() {
		return "This rule will set the information to attach the portfolio while sending notifications";
	}
