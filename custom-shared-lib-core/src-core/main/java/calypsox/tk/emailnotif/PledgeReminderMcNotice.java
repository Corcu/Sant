...
public class PledgeReminderMcNotice extends EmailDataBuilder {
    public PledgeReminderMcNotice(BOMessage message) {
        super(message);
    ...
    private String buildSubject() {
        ...
        return "*****PLEDGE REMINDER******* Margin Call Notice " + mccName + " - " + po + " - " + ampid;
    }
}
