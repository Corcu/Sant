 ...
 */
public class ApplyActionToMessageAttributesRetriedAction extends RetriedAction {
     ...
     */
    @SuppressWarnings("rawtypes")
    public ApplyActionToMessageAttributesRetriedAction(final long messageId,
                ...
                if(message.getAttributes()==null){
                    ...
                    for (int i=0; i < this.attributes.size(); i++){
                        if(i+1 <= this.attributes.size()) {
                            message.setAttribute((String) this.attributes.get(i), (String) this.attributes.get(i+1));
                            i++;
                        }
                    }
                }
