...
public class Opt_Collateral_MarginCallReportStyle extends MarginCallReportStyle {
    ...
    // Default columns.
    public static final String[] DEFAULTS_COLUMNS = { MARGINCALLCONTRACT,
	    OWNER, OWNERNAME, COUNTERPARTY, LONGNAMECOUNTERPARTY, CONTRACTTYPE,
	    MASTERAGREEDESCRIPTION, CONTRACTCCY, MTACPTY, MTAOWNER,
	    THRESHOLDCPTY, THRESHOLDOWNER, INITIALMARGIN, CALCPERIOD,
	    FIRSTCALCDATE, ASSETTYPE, ONEWAY, CONTRACTLONGNAME,
	    MASTERAGREEMENTSHORTNAME, TRANSACTIONID, TRANSACTIONTYPE, ACTION,
	    RECONCILIATIONTYPE, TRANSACTIONDATE, MATURITYDATE, LEADCURRENCY,
	    COLLATERALAMOUNT, ISRECEIVED, ISSUER, BONDMATURITYDATE, HEADCLONE,
	    NOTUSED, MASTERSIGNEDDATE, DELIVERYROUNDING, DELIVERYROUNDINGCPTY,
	    DELIVERYROUNDINGOWNER, TOLERANCEAMOUNT, ASSETTYPE2,
	    INDEPENDENTAMOUNTCPTY, INDEPENDENTAMOUNTOWNER, INITIALMARGIN2,
	    INSTRUMENT, HEADER, ISIN, DIRTYPRICE, HAIRCUT,
	    INSTRUMENTDESCRIPTION, OFFICE, AGREEMENTTYPE, AGREEMENTID,
	    COLLBONDNOMINAL, INDEPENDENTAMOUNT, SOURCE, CONCILIA };
	...
	final Opt_Collateral_MarginCallItem item = (Opt_Collateral_MarginCallItem) row
		.getProperty(Opt_Collateral_MarginCallItem.OPTCOL_MARGINCALL_ITEM);
