...
public class Opt_InfRatesReportStyle extends QuoteReportStyle {
	...
	// Default columns.
	public static final String[] DEFAULT_COLUMNS = {FH_CONCILIA, FEED, LADO, INDEX, PRICE, QUOTE_SET};
	...
	public Object getColumnValue(ReportRow row, String columnName,  @SuppressWarnings("rawtypes") Vector errors)
		...
		Opt_InfRatesItem item = (Opt_InfRatesItem) row.getProperty(Opt_InfRatesItem.OPT_INFRATES_ITEM);
