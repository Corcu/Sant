 ...
 */
public class Opt_EquityPricesLogic {
    ...
    public Opt_EquityPricesLogic() {
    }

    @SuppressWarnings("unused")
    private Opt_EquityPricesItem getExpTLM_EquityPricesItem(final Vector<String> errors) {
        return null;
    }
    ...
    public String getIsin(final QuoteValue qv, final DSConnection dsConn) {
        ...
        try {
            ...
            final Vector<ProductDesc> v = rp.getAllProductDesc(clausule, CustomBindVariablesUtil.createNewBindVariable(qv.getName()));
            if (!Util.isEmpty(v)) {
     ...
     */
    public static Vector<Opt_EquityPricesItem> getReportRows(final QuoteValue qv, final String date,
                                                             final String feed, final DSConnection dsConn, final Vector<String> errorMsgs) {

        final Vector<Opt_EquityPricesItem> reportRows = new Vector<>();
        final Opt_EquityPricesLogic verifiedRow = new Opt_EquityPricesLogic();
        Opt_EquityPricesItem rowCreated = null;
        fecha = date;
        feed_name = feed;
     ...
     */
    private Opt_EquityPricesItem getExpTLM_EquityPricesItem(final QuoteValue qv, final DSConnection dsConn,
                                                            final Vector<String> errors) {

        final Opt_EquityPricesItem expTLM_EquityPricesItem = new Opt_EquityPricesItem();
        ...
        if (qv != null) {
            ...
            expTLM_EquityPricesItem.setQuoteset(getQuoteset(qv));
