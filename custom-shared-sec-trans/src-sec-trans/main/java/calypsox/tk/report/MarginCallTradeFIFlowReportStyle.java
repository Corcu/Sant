 ...
 * @author aalonsop
 */
public class MarginCallTradeFIFlowReportStyle extends TradeReportStyle {
    ...
    public Object getColumnValue(ReportRow row, String columnId, Vector errors) {
        Object columnValue;
        CalypsoToTCyCCBean bean = row.getProperty(MarginCallTradeFIFlowReport.ROW_PROP_NAME);
