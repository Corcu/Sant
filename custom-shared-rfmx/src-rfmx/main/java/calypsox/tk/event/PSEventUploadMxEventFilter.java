 ...
 * F.e. If we want to allow MxLegalEntity gateway events to be consumed, a class called PSEventUploadMxLegalEntityEventFilter
 * and extending this one has to be created. This new class wont contain any logic.
 * 
 * This class is equivalent to PSEventUploadEventFilter, except that we will only use our class 
 * for Mexico developments.
 *
 */
public abstract class PSEventUploadMxEventFilter implements EventFilter {
