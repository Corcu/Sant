 ...
 * @since 5.0, 10/12/01
 */
public class TibcoQueueIEAdapter extends SantanderIEAdapter implements MessageListener, ExceptionListener {
    ...
    // MessageListener _mlistener = null;
    // ExceptionListener _elistener = null;
     ...
     * @param true = receiver
     */
    public TibcoQueueIEAdapter(int opMode) {
        this._opMode = opMode;
    }
    ...
    public void onMessage(Message mess) {
        ...
        try {
            if (mess instanceof TextMessage) {
                ...
                Log.debug(this, "TibcoQueueIEAdapter.onMessage with message=" + mess.toString() + " and JMSMessageId="
    ...
    private void initReceiver() throws ConnectException {
        ...
        try {
            ...
            throw new ConnectException("Failed to set the message Listener: " + e.getClass() + ": " + e.getMessage());
        } // end of try-catch
    ...
    private void createProviderConnection(Hashtable<String, String> props) throws ConnectException {
        ...
        try {
            ...
            Log.info(this, "Queue connection was succesfuly created to " + _jmsUrl);
        } catch (JMSException e) {
            Log.error(this, e);
    ...
    private Queue locateQueue(Queue queue, String queueName) throws ConnectException {
        ...
        if (queue == null) {
            try {
                ...
                Log.info(this, queueName + " was successfuly located");
            } catch (JMSException e) {
    ...
    private void createQueueReceiver() throws ConnectException {
        if (this._receiverQueue == null) {
            try {
                ...
                Log.info(this, "Message consumer was created within " + _receiverQueueName);
            } catch (JMSException e) {
    ...
    private void createQueueSender() throws ConnectException {
        if (this._senderQueue == null) {
            try {
                ...
                Log.info(this, "Message producer was created within " + _senderQueueName);
            } catch (JMSException e) {
    ...
    public boolean writeMessageCorrelationId(JMSQueueMessage message) {
        try {
            ...
            Log.debug(this, "TibcoQueueIEAdapter.write Sending msg Text:" + msg.getText() + " with JMSCorrelationID="
        ...
        Log.system(TibcoQueueIEAdapter.class.getName(), "Ha enviado correctamente el mensaje --------------> " + message.toString());
        return true;
    }
