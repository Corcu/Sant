 ...
 */
public class SantanderJMSQueueIEAdapterConfig extends SantanderIEAdapterConfig {

    protected SantanderJMSQueueIEAdapter santanderJMSQueueIEAdapter = null; //sonar 02/07/2017

    /**
     * Constructor
     */
    public SantanderJMSQueueIEAdapterConfig() {
    }
     ...
     */
    public SantanderJMSQueueIEAdapterConfig(final String type) {
        super(type);
    }
    ...
    public synchronized SantanderIEAdapter getSantReceiverIEAdapter() {
        ...
        if (this.santanderJMSQueueIEAdapter == null) {
            this.santanderJMSQueueIEAdapter = new SantanderJMSQueueIEAdapter();
            this.santanderJMSQueueIEAdapter.setIEAdapterConfig(this);
        }
        return this.santanderJMSQueueIEAdapter;
    }
