...
public enum SantCommonExceptionType {
    ...
    /** Exception matching transfer status for MT537 */
    RECON_MT537_MATCHED(
            "EX_RECON_MT537_MATCHED",
            "Exception processing PaymentsHub Callback.",
            null),

    /** Exception matching transfer not found fot MT537 */
    RECON_MT537_UNMATCHED(
            "EX_RECON_MT537_UNMATCHED",
            "Acording to the agent, the transfer should be failed.",
            null);
    ...
    SantCommonExceptionType(String type, String description, ErrorCodeEnum errorCodeEnum) {
        this.type = type;
