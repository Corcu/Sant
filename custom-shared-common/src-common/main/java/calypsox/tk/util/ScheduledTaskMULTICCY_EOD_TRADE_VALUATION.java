...
public class ScheduledTaskMULTICCY_EOD_TRADE_VALUATION extends ScheduledTaskEOD_TRADE_VALUATION {


    @Override
    public String getTaskInformation() {
        return "Compute MultiCcy Valuation";
    }
    ...
    public Vector getAttributeDomain(String attr, Hashtable currentAttr) {
        Vector v;
        if (attr.equals("VALUATION")) {
            v = new Vector();
            v.addElement("MULTICCY");
            return v;
        }
        else {
    ...
    protected boolean handleTradeValuation(DSConnection ds, PSConnection ps, Task task, long maxWaitTime, TaskArray tasks) {
        ...
        ValuationUtil valuationUtil = new MultiCcyValuationUtil();
