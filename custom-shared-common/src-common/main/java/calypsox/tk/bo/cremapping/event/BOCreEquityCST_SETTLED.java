...
import calypsox.tk.bo.cremapping.util.EquityBOCreSettleMethodHandler;
...
public class BOCreEquityCST_SETTLED extends SantBOCre {

    private Product security;

    public BOCreEquityCST_SETTLED(BOCre cre, Trade trade) {
        super(cre, trade);
    }
