...
public class BOCreCADividendCST_UNNET extends SantBOCre {

    private Product security;

    public BOCreCADividendCST_UNNET(BOCre cre, Trade trade) {
        super(cre, trade);
    }
    ...
    public void fillValues() {
        ...
        if (("MarginCall").equals(this.claimProductType))
            this.accountCreditDebit = getDebitCredit(-this.boCre.getAmount(0));
