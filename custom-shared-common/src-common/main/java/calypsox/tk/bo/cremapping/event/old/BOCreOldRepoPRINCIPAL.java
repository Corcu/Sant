...
public class BOCreOldRepoPRINCIPAL extends SantBOCre {

    public BOCreOldRepoPRINCIPAL(BOCre cre, Trade trade) {
        super(cre, trade);
    }
    ...
    protected String getSubType(){
        ...
        if(null!=this.creBoTransfer){
            String eventTypeActionName = this.creBoTransfer.getAttribute("EventTypeActionName");
