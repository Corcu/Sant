...
public class BOCreOldRepoINTEREST extends SantBOCre{

    public BOCreOldRepoINTEREST(BOCre cre, Trade trade) {
        super(cre, trade);
    }
    ...
    protected void fillValues() {
        ...
        this.maturityDate = BOCreUtils.getInstance().loadRepoInterestMaturityDate(this.creBoTransfer);
        ...
        this.nettingNumber = BOCreUtils.getInstance().getNettingNumber(this.creBoTransfer,this.trade);
