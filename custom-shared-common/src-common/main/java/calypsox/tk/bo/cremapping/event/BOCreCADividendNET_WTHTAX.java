...
public class BOCreCADividendNET_WTHTAX extends BOCreCADividendCST{

    private Equity security;

    public BOCreCADividendNET_WTHTAX(BOCre cre, Trade trade) {
        super(cre, trade);
    }
    ...
    public void fillValues() {
        this.eventType = BOCreConstantes.EVENT_TYPE_NET_WTHTAX;
        ...
        this.issuerISOCode = BOCreUtils.getInstance().loadWithholdingTaxConfigId(this.trade);
