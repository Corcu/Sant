...
import com.calypso.tk.swift.formatter.MT292SWIFTFormatter;
...
/**
 * <p>
 * Title: PHLegacyMT292SWIFTFormatter
 * </p>
 * <p>
 * Description: Optional Tag 79 should contain a specific custom description. This 79 does not exist
 * in the current MT292 template: It will be a single fixed text "PLEASE CANCEL THE PAYMENT (VALUE
 * DATE, AMOUNT, CCY, REFERENCE) AS SOON AS POSSIBLE, THANK YOU, BANCO SANTANDER" . Bracket
 * information shall be fulfilled by Calypso
 * </p>
 *
 */
public class MT292PHLegacySWIFTFormatter extends MT292SWIFTFormatter {


    private static final String LOG_CATEGORY = MT292PHLegacySWIFTFormatter.class.getSimpleName();
