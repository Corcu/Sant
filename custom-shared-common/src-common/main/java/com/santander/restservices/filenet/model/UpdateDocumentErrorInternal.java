...
public class UpdateDocumentErrorInternal extends ApiRestModelRoot
{
    ...
    public UpdateDocumentErrorInternal()
    {
        super();
    }

    public UpdateDocumentErrorInternal(UpdateDocumentErrorInternal error) 
    {
		this();
		loadModelData(error);
	}
	...
	public void loadModelData(ApiRestModel model) 
	{
        if (model != null)
        {
            if (model instanceof UpdateDocumentErrorInternal)
            {
            	UpdateDocumentErrorInternal data = (UpdateDocumentErrorInternal) model;
	...
	@Override
	public Class<UpdateDocumentErrorInternal> retriveModelClass() 
	{
        return UpdateDocumentErrorInternal.class;
	}
}
