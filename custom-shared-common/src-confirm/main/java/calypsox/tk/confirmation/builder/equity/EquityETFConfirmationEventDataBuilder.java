...
public class EquityETFConfirmationEventDataBuilder extends CalConfirmationEventDataBuilder {


    public EquityETFConfirmationEventDataBuilder(BOMessage boMessage, BOTransfer boTransfer, Trade trade) {
