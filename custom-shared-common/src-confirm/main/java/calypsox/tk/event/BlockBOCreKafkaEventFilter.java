...
public class BlockBOCreKafkaEventFilter implements EventFilter {
    /**
    ...
    public boolean accept(PSEvent event) {
        ...
        if (event instanceof PSEventCre) {
            ...
            res = BlockBOCreUtil.checkEvent(boCre,"CreOnlineKafkaSenderEngine",engineName,"CreAccountingRulesKafka");
        }
        return res;
    }
