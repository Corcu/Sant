...
public class SantBloombergUpdaterEngineTest {
    ...
    protected SantBloombergUtil mockedUtil;
    ...
    public void testProcess() {
        ...
        // this.testClass.setSantBloombergUtil(mockedUtil);
    ...
    private void mockDsConnection() {
        ...
        mockSt = Mockito.spy(new ScheduledTaskSANT_BLOOMBERG_TAGGING());
        ...
        try {
            ...
            mockSt.setAttribute(ScheduledTaskSANT_BLOOMBERG_TAGGING.FILENAME_FULL, "");
            ...
            mockedUtil = Mockito.mock(SantBloombergUtil.class);

            Mockito.doReturn(true).when(mockedUtil).processBloombergFileMap("", "", null, "", null);
