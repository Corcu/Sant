 ...
 * 
 */
public enum SantInitialMarginCalypsoErrorCodeEnum {
	...
	/** Currency PO received not valid */
	CurrencyPONotValid(6, "Currency PO not valid"),
	
	/** Currency CPTY received not valid */
	CurrencyCPTYNotValid(7, "Currency CPTY not valid"),
	
	/** Format error not valid */
	FormatErrorNotValid(8, "Format error not valid"),
	
	/** Format Date not valid */
	FormatDateNotValid(9, "Format error not valid")
	...
	private SantInitialMarginCalypsoErrorCodeEnum(final int code, final String message) {
		setCode(code);
		setMessage(message);
	}
	 ...
	 */
	public static SantInitialMarginCalypsoErrorCodeEnum isValid(int errorCode) {
		SantInitialMarginCalypsoErrorCodeEnum returnValue = null;

		try {
			for (SantInitialMarginCalypsoErrorCodeEnum errorValue : SantInitialMarginCalypsoErrorCodeEnum.values()) {
