...
public abstract class ImportMessageEngine extends Engine implements ExtendedIEAdapterListener {

    /**
     * Default name of the engine.
     */
    private static final String ENGINE_NAME_STR = "ImportMessageEngine";
     ...
     */
    public ImportMessageEngine(DSConnection dsCon, String hostName, int esPort) {
     ...
     */
    @Deprecated
    public ImportMessageEngine(String configName, DSConnection dsCon, String hostName, int esPort) {
        super(dsCon, hostName, esPort);
    ...
    public void setIEAdapter(IEAdapter adapter) {
        if (adapter instanceof SantanderIEAdapter) {
            ...
            Log.error(ImportMessageEngine.class.getSimpleName(), "Couldn't set ImportMessageEngine IEAdapter, " +
