 ...
 * 
 */
public final class MisFileUtility {
    private static final int BUFFER_SIZE = 1024;

    private MisFileUtility() {
        // do nothing
    }
    ...
    public static void copyFile(final String inputFileName,
        ...
        try {
            ...
            Log.error(MisFileUtility.class, e);
        } finally {
            try {
                if (out != null) {
                    out.close();
                ...
                Log.debug(MisFileUtility.class,
    ...
    public static void moveFile(final String inputFileName,
        ...
        MisFileUtility.copyFile(inputFileName, outputFileName);
    ...
    public static void createZip(final String[] filenames,
        ...
        try {
            ...
            try {
                ...
                Log.error(MisFileUtility.class,
                        "Couldn't close Stream: " + e.getMessage(), e);
            }
        }
