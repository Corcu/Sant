...
import static calypsox.tk.upload.uploader.util.UploadBondMultiCCyUtil.*;

public class UploadCalypsoTradeFXForward extends com.calypso.tk.upload.uploader.UploadCalypsoTradeFXForward implements ClearingTradeFilterAdapter, ReprocessKwdValidator {
