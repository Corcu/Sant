...
public class FI105_EquityReportStyle extends TradeReportStyle {
    ...
    public Object getColumnValue(ReportRow row, String columnName, Vector errors) {
        ...
        FI105EquityBean bean = row.getProperty(FI105EquityBean.class.getSimpleName());

        if (null != trade.getProduct() && bean != null) {
